...
public class GridViewVer extends ArrayAdapter<GridItem> {

    private Context mContext;
    private int layoutResourceId;
    private ArrayList<GridItem> mGridData = new ArrayList<GridItem>();

    public GridViewVer(Context mContext, int layoutResourceId, ArrayList<GridItem> mGridData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GridViewIndicadores.ViewHolder holder;
...
//            holder.courseTextView.setVisibility(View.INVISIBLE);
            ...
            holder = (GridViewIndicadores.ViewHolder) row.getTag();
...
//   holder.courseTextId.setText(Html.fromHtml(item.getId()));
        ...
        if(item.getTitle().equals("EDUCACIÓN")){
